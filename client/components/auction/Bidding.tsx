...
import {socket} from '../chat/communication'
...
export default function Bidding (props) {
    ...
    return(
        <div>
            ...
            <Box sx={{m:2, bgcolor: 'background.paper', display: 'inline-block'}}>
                <TextField id="bid" label="Your Bid ($)"  
                        ...
                        sx={{m: 4}}/><br/>
                <Button variant="contained" sx={{m: 4}} color="secondary" disabled={bid < (minBid + 1)} onClick={placeBid} >Place Bid</Button><br/>
            </Box>}
            <Box sx={{mt: 2, gbcolor: 'background.paper', p: 2}}>
