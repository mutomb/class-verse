...
import {Box, Card, CardActions, CardContent, CardHeader, Grid, Typography, cardHeaderClasses, Link as MuiLink, useMediaQuery, Divider, Fade, cardContentClasses} from '@mui/material';
              ...
              <Box component='span'>
                ...
                <CardActions sx={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', '& > a':{ mb: 1, ml: '0px !important', width: 'fit-content'}}}>
                  <Box component='a' href={"https://connect.stripe.com/oauth/authorize?response_type=code&client_id="+stripe_connect_test_client_id+"&scope=read_write"}>
                    ...
                    startIcon={
                      <Typography component="h2" variant="h3" sx={{ color: 'primary.contrastText'}}>
                        S <Divider component='span' sx={{ height: 28, m: 0.5,}} orientation="vertical" />
                      </Typography> 
                    }>
                      Connect with Stripe
                    </StyledButton>
                  ...
                  <Box component='a' href={"https://connect.stripe.com/oauth/authorize?response_type=code&client_id="+stripe_connect_test_client_id+"&scope=read_write"}>
                    ...
                    startIcon={
                      <Typography component="h2" variant="h3" sx={{ color: 'primary.contrastText'}}>
                        P <Divider component='span' sx={{ height: 28, m: 0.5,}} orientation="vertical" />
                      </Typography> 
                    }>
                      Connect with Paypal
                    </StyledButton>
